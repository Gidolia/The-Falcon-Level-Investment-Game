          ...
          <div class="row justify-content-center">
            ...
            <form action="" method="post">
              <div class="form-group first">
                ...
                <input type="button" name="resend"value="Request Resend OTP" class="btn-forgot btn-primary"></span>
                 </div>
              <div class="form-group first">
             ...
             <input type="submit" name="" value="Change Password" class="btn btn-block btn-primary"><br/>
