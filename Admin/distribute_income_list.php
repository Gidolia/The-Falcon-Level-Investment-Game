...
<head>
  ...
  <title>Distribute Income List</title>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Distribute Income List</li>
      </ol>
    </nav>
    ...
    <div class="div">
     ...
     <?php 
     $rs=1;
     $rr="SELECT * FROM `daily_return_record` ORDER BY `daily_return_record`.`drr_id` DESC";
     $r=$con->query($rr);
