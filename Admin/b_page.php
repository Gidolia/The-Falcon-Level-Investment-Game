  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">LPG Cylinder</li>
      </ol>
    </nav>
 ...
 <!-- forms  -->
            <div class="card card_border py-2 mb-4 col-md-6">
				...
				<div class="cards__heading" style="text-align:center;" >
                    <h3>LPG CYLINDER PAYMENT</h3>
                </div>
                    <div class="card-body">
					 <div class="form-group col-md-12">
                                <label for="inputState" class="input__label">Select operator to proceed</label>
                                <select  class="form-control input-style">
                                    <option selected>Select Operator To Proceed</option>
