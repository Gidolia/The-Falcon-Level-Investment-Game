...
<head>
  ...
  <title>Withdrawal Cancel Request</title>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Withdrawal Cancel Request</li>
      </ol>
    </nav>
 ...
 <!-- forms  -->
            <div class="card card_border col-md-12">
				...
				<div class="cards__heading" style="text-align:laft;" >
                    <h3>Withdrawal Cancel Request</h3>
                </div>
                     ...
                     <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                          <?php 
                                ...
                                $e="SELECT * FROM `withdrawal_record` WHERE `status`='r'";
                                $d=$con->query($e);
